...
def get_official_eval_result(gt_annos, dt_annos, current_classes, difficultys=[0, 1, 2], return_data=False):
    ...
    compute_aos = False
    mAPbbox, mAPbev, mAP3d = do_eval_v2(gt_annos, dt_annos, current_classes, min_overlaps, compute_aos, difficultys)
    ...
    if return_data:
        return result, mAPbbox, mAPbev, mAP3d
    else:
        return result
...
def do_eval_v2(gt_annos,
    ...
    ret = eval_class_v3(gt_annos, dt_annos, current_classes, difficultys, 2, min_overlaps)
